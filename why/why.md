...
### [Demo](https://github.com/overhide/overhide-remuneration-demo)

Before diving any deeper into describing [*overhide-ledger*](https://ohledger.com), the concepts just described may become more tangible through a [demo](https://github.com/overhide/overhide-remuneration-demo) meant to help developers see the approach in a "real" application.

We have a functioning [demo "game"](https://github.com/overhide/overhide-remuneration-demo) with a sample login page.  The login page allows either a free account login or value-add pay-for tiers.  Payments in this game can be made using either Ethereum or dollars.

Go check the demo out at [https://github.com/overhide/overhide-remuneration-demo](https://github.com/overhide/overhide-remuneration-demo).
...
We have covered enough about the why, let's get into the how--[*overhide-ledger*](https://ohledger.com) creates its ledger.
