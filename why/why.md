...
All the documentation ([GitHub](https://github.com/overhide/overhide)) ([intro slides](https://overhide.io/overhide/)) for the *data-broker*   are released.  Currently working towards a [minimally-viable product](https://github.com/overhide/overhide/blob/master/docs/mvp.md) before putting the broker reference implementation on GitHub.
